<template>
  <section id="home" class="pt-20 pb-12 bg-gradient-to-r from-gray-50 to-gray-100">
      ...
      <div class="flex flex-col-reverse md:flex-row items-center justify-between gap-8">
        ...
        <div class="w-full md:w-1/2 space-y-6">
          ...
          <p class="text-lg text-gray-600">
            Belajar Programming Itu Mudah dan Menyenangkan 😊
          </p>
          <a 
        ...
        <div class="w-full md:w-1/2">
          <img 
            src="https://images.pexels.com/photos/3779764/pexels-photo-3779764.jpeg?auto=compress&cs=tinysrgb&w=400" 
            alt="Profile" 
